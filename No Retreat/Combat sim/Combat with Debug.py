...
class fighter:
    ...
    def act(self, arena)->list:
        ...
        #print("DEBUG: my name is")
        #print(self.name)
        #print("DEBUG: am I stunned?")
        #print(self.stunned)
        try:
            if self.is_alive() == True:    
                if self.stunned > 0:
                    #print("DEBUG: do I know I''m stunned")
                    #print(self.stunned)
                    self.stunned -= 1
                    if self.stunned > 0:
                    ...
                    for combatatent in arena:
                        #print("DEBUG: is in arena")
                        #print(combatatent.name)
...
def printScreen(arena:list, distance:int):
    #print("DEBUG: team 1 HP")
    #print(getTeamHp(arena,True))
    #print("DEBUG: team 1 MaxHP")
    #print(getTeamMaxHp(arena,True))
...
b = fighter("Troll", 40, 40, 8, 2, 0,  0.5,   False, 0.5, 1)
